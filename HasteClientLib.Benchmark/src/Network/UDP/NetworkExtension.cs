...
namespace Haste.Network
{
    internal static class NetworkExtension
    {
        ...
        public static uint CalculateCrc(this byte[] buffer, long len)
        {
            unchecked
            {
        ...
        public static uint CalculateCrc(this IByteBuffer buffer)
        {
            return buffer.ToArray().CalculateCrc(buffer.Count);
        }
